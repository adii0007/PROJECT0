...
<body style="background-image: url(../img/download.jpg); height:auto;  width:auto; background-size: cover;">
	<div class="header">
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="password" class="form-control" name="confirmPassword" placeholder="confirmPassword" value="<%=DataUtility.getStringData(dto.getPassword())%>">
      </div>
    </div>
