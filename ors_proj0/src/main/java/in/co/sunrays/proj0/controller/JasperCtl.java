...
public class JasperCtl {
	...
	public void display(HttpServletRequest request, HttpServletResponse response) throws JRException, SQLException, IOException {
		...
		String path = context.getRealPath("G:\\sumit new proj0\\SpringMVC-master\\ors_proj0\\src\\main\\webapp\\WEB-INF\\Cherry_1.jrxml");
		System.out.println("in jasper");
		Connection con = null;
		JasperReport jasperReport = JasperCompileManager.compileReport("G:\\sumit new proj0\\SpringMVC-master\\ors_proj0\\src\\main\\webapp\\WEB-INF\\Cherry_1.jrxml");
